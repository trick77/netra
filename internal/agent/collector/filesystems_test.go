...
func TestFilesystemsReportsUsagePerMount(t *testing.T) {
	testee := collector.NewFilesystems("testdata/mounts", nil, fakeStatfs(map[string]collector.FsStat{
...
func TestFilesystemsReportsAnUnreadableMountTable(t *testing.T) {
	testee := collector.NewFilesystems(t.TempDir(), nil, fakeStatfs(nil))
