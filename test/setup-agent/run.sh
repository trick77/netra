#!/bin/sh
#
# Test runner for setup-agent.sh.
#
#   sh   test/setup-agent/run.sh            # all cases
#   dash test/setup-agent/run.sh            # same cases, under dash
#   sh   test/setup-agent/run.sh preflight  # only cases matching a pattern
#
...
# EMPTY — the setup script probes for their existence, not their contents
